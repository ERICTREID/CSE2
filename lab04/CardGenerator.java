    ...
    public static void main(String[] args){
        ...
        if(card<=26&&card>13){
            ...
            switch (card){
                ...
                break;
                default:
                    System.out.println("You picked the "+(card-13)+" of clubs");//print all other statments
                break;
            }
        }
        if(card<=39&&card>26){
            ...
            switch (card){
                ...
                break;
                default:
                    System.out.println("You picked the "+(card-26)+" of hearts");//print all other statments
                break;
            }
        }
        if(card>39){
            ...
            switch (card){
                ...
                break;
                default:
                    System.out.println("You picked the "+(card-39)+" of spades");//print all other statments
                break;
            }
        }
